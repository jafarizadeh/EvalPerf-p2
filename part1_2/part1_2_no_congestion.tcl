# ================================
# Partie 1.2 - cas sans congestion
# ================================

set ns [new Simulator]

set ftrace [open part1_2_no_congestion.tr w]
$ns trace-all $ftrace
...
# Liens d'acces (delais heterogenes)
...
# Lien de coeur tres large => pas de goulet
$ns duplex-link $n3 $n4 300Mb 10ms DropTail
$ns queue-limit $n3 $n4 200
$ns queue-limit $n4 $n3 200

# Fonction pour un flux TCP/FTP
...
proc finish {} {
    ...
    $ns flush-trace
    close $ftrace
    puts "Fin simulation sans congestion t=$simTime s"
    exit 0
}
