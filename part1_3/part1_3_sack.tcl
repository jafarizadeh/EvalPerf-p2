# ================================
# Partie 1.3 - Sack1 (remplace Cubic)
# RTT homogenes + file du goulet
# ================================

set ns [new Simulator]

set ftrace [open part1_3_sack.tr w]
$ns trace-all $ftrace
...
# 6 flux Sack1
create_tcp_ftp $ns $n0 $n5 0 Sack1 tcp0 sink0 ftp0
create_tcp_ftp $ns $n0 $n5 1 Sack1 tcp1 sink1 ftp1

create_tcp_ftp $ns $n1 $n6 2 Sack1 tcp2 sink2 ftp2
create_tcp_ftp $ns $n1 $n6 3 Sack1 tcp3 sink3 ftp3
