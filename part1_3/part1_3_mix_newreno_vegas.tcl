# ==========================================
# Partie 1.3 - Mix NewReno vs Vegas
# RTT homogenes + competition variantes
# ==========================================

set ns [new Simulator]

set ftrace [open part1_3_mix_newreno_vegas.tr w]
$ns trace-all $ftrace
...
set qtrace [open part1_3_mix_newreno_vegas_queue.tr w]
...
proc finish {} {
    ...
    close $ftrace
    close $qtrace
    puts "Fin Mix NewReno/Vegas t=$simTime s"
    exit 0
}
