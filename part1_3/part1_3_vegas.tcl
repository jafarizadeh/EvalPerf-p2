...
set ftrace [open part1_3_vegas.tr w]
$ns trace-all $ftrace
...
set qtrace [open part1_3_vegas_queue.tr w]
...
# 6 flux Vegas
create_tcp_ftp $ns $n0 $n5 0 Vegas tcp0 sink0 ftp0
create_tcp_ftp $ns $n0 $n5 1 Vegas tcp1 sink1 ftp1

create_tcp_ftp $ns $n1 $n6 2 Vegas tcp2 sink2 ftp2
create_tcp_ftp $ns $n1 $n6 3 Vegas tcp3 sink3 ftp3

create_tcp_ftp $ns $n2 $n7 4 Vegas tcp4 sink4 ftp4
create_tcp_ftp $ns $n2 $n7 5 Vegas tcp5 sink5 ftp5
