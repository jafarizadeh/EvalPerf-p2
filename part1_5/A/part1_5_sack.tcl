# ======================================
# Partie 1.5A - Sack1, extensibilite 10Gbps
...
set rfile [open thr_part1_5_sack.txt w]
...
proc finish {} {
    ...
    puts $rfile "Throughput Sack1 = [format %.3f $thr] Mbps"
    close $rfile
    puts "Fin Sack1 haut debit t=$simTime s"
    exit 0
}
