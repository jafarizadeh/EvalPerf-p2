# ======================================
# Partie 1.4 - RED (taille file variable)
...
set ftrace [open "part1_4_red_${qlim}.tr" w]
$ns trace-all $ftrace
...
# Parametres simples RED
set redq [[$ns link $n3 $n4] queue]
set minth [expr int($qlim/3)]
set maxth [expr int(2*$qlim/3)]
$redq set minth_ $minth
$redq set maxth_ $maxth
$redq set q_weight_ 0.002

# Trace de la file
set qtrace [open "part1_4_red_${qlim}_queue.tr" w]
...
proc finish {} {
    ...
    close $ftrace
    close $qtrace
    puts "Fin RED qlim=$qlim t=$simTime s"
    exit 0
}
